...
pth0='/home/testuser/OSIRIS/mag_recon';
pth1='/MS/DENSITY/Elec2/charge/';
pth2='/MS/FLD/b1/';
pth3='/MS/FLD/b2/';
...
%============AVI-FILE-NAME==========================
writerObj = VideoWriter ('beamden12.avi');
writerObj.FrameRate=5;
open(writerObj);
% aviobj = avifile ( 'eden-b-field', 'fps',5); 
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
for ii=1:4:length(frm)   
...
%     set(cb,'position',[.13 .35 .335 .02]);
    title(strcat('e-Density:',num2str(time_qe)));  hold off;
