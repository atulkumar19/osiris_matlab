...
pth0='/home/atul/OSIRIS/MS25-0.5-nob3';
...
%         AshReadRaw(fl_nm18);
%     [ene_raw,x1_raw,p1_raw19,x2_raw,p2_raw19,tag_raw1,xlt_in,xlt_fi]=...
%         AshReadRaw(fl_nm19);
%     [ene_raw,x1_raw,p1_raw20,x2_raw,p2_raw20,tag_raw2,xlt_in,xlt_fi]=...
%         AshReadRaw(fl_nm20);
%     [ene_raw,x1_raw,p1_raw21,x2_raw,p2_raw21,tag_raw3,xlt_in,xlt_fi]=...
%         AshReadRaw(fl_nm21);
%     [ene_raw,x1_raw,p1_raw22,x2_raw,p2_raw22,tag_raw4,xlt_in,xlt_fi]=...
%         AshReadRaw(fl_nm22);
%     [ene_raw,x1_raw,p1_raw23,x2_raw,p2_raw23,tag_raw5,xlt_in,xlt_fi]=...
%         AshReadRaw(fl_nm23);
%     [ene_raw,x1_raw,p1_raw24,x2_raw,p2_raw24,tag_raw6,xlt_in,xlt_fi]=...
%         AshReadRaw(fl_nm24);
%     [ene_raw,x1_raw,p1_raw25,x2_raw,p2_raw25,tag_raw7,xlt_in,xlt_fi]=...
%         AshReadRaw(fl_nm25);
%     [ene_raw,x1_raw,p1_raw26,x2_raw,p2_raw26,tag_raw8,xlt_in,xlt_fi]=...
%         AshReadRaw(fl_nm26);
%     [ene_raw,x1_raw,p1_raw27,x2_raw,p2_raw27,tag_raw9,xlt_in,xlt_fi]=...
%         AshReadRaw(fl_nm27);
%     [ene_raw,x1_raw,p1_raw28,x2_raw,p2_raw28,tag_raw10,xlt_in,xlt_fi]=...
%         AshReadRaw(fl_nm28);
%     [ene_raw,x1_raw,p1_raw29,x2_raw,p2_raw29,tag_raw,xlt_in,xlt_fi]=...
%         AshReadRaw(fl_nm29);
%     [ene_raw,x1_raw,p1_raw30,x2_raw,p2_raw30,tag_raw1,xlt_in,xlt_fi]=...
%         AshReadRaw(fl_nm30);
%     [ene_raw,x1_raw,p1_raw31,x2_raw,p2_raw31,tag_raw2,xlt_in,xlt_fi]=...
%         AshReadRaw(fl_nm31);
%     [ene_raw,x1_raw,p1_raw32,x2_raw,p2_raw32,tag_raw3,xlt_in,xlt_fi]=...
%         AshReadRaw(fl_nm32);
%     [ene_raw,x1_raw,p1_raw33,x2_raw,p2_raw33,tag_raw4,xlt_in,xlt_fi]=...
%         AshReadRaw(fl_nm33);
%     [ene_raw,x1_raw,p1_raw34,x2_raw,p2_raw34,tag_raw5,xlt_in,xlt_fi]=...
%         AshReadRaw(fl_nm34);
%     [ene_raw,x1_raw,p1_raw35,x2_raw,p2_raw35,tag_raw6,xlt_in,xlt_fi]=...
%         AshReadRaw(fl_nm35);
%     [ene_raw,x1_raw,p1_raw36,x2_raw,p2_raw36,tag_raw7,xlt_in,xlt_fi]=...
%         AshReadRaw(fl_nm36);
%     [ene_raw,x1_raw,p1_raw37,x2_raw,p2_raw37,tag_raw8,xlt_in,xlt_fi]=...
%         AshReadRaw(fl_nm37);
%     [ene_raw,x1_raw,p1_raw38,x2_raw,p2_raw38,tag_raw9,xlt_in,xlt_fi]=...
%         AshReadRaw(fl_nm38);
%     [ene_raw,x1_raw,p1_raw39,x2_raw,p2_raw39,tag_raw10,xlt_in,xlt_fi]=...
%         AshReadRaw(fl_nm39);
%     [ene_raw,x1_raw,p1_raw40,x2_raw,p2_raw40,tag_raw,xlt_in,xlt_fi]=...
%         AshReadRaw(fl_nm40);
%     [ene_raw,x1_raw,p1_raw41,x2_raw,p2_raw41,tag_raw11,xlt_in,xlt_fi]=...
%         AshReadRaw(fl_nm41);
%     [ene_raw,x1_raw,p1_raw42,x2_raw,p2_raw42,tag_raw12,xlt_in,xlt_fi]=...
%         AshReadRaw(fl_nm42);
%     [ene_raw,x1_raw,p1_raw43,x2_raw,p2_raw43,tag_raw,xlt_in,xlt_fi]=...
%         AshReadRaw(fl_nm43);
%     [ene_raw,x1_raw,p1_raw44,x2_raw,p2_raw44,tag_raw13,xlt_in,xlt_fi]=...
%         AshReadRaw(fl_nm44);
%     [ene_raw,x1_raw,p1_raw45,x2_raw,p2_raw45,tag_raw14,xlt_in,xlt_fi]=...
%         AshReadRaw(fl_nm45);
%     
...
%     p_raw_sq19=p1_raw19.*p1_raw19+p2_raw19.*p2_raw19;p_raw_sq20=p1_raw20.*p1_raw20+p2_raw20.*p2_raw20;
%     p_raw_sq21=p1_raw21.*p1_raw21+p2_raw21.*p2_raw21;p_raw_sq22=p1_raw22.*p1_raw22+p2_raw22.*p2_raw22;
%     p_raw_sq23=p1_raw23.*p1_raw23+p2_raw23.*p2_raw23;p_raw_sq24=p1_raw24.*p1_raw24+p2_raw24.*p2_raw24;
%     p_raw_sq25=p1_raw25.*p1_raw25+p2_raw25.*p2_raw25;p_raw_sq26=p1_raw26.*p1_raw26+p2_raw26.*p2_raw26;
%     p_raw_sq27=p1_raw27.*p1_raw27+p2_raw27.*p2_raw27;p_raw_sq28=p1_raw28.*p1_raw28+p2_raw28.*p2_raw28;
%     p_raw_sq29=p1_raw29.*p1_raw29+p2_raw29.*p2_raw29;%p_raw_sq30=p1_raw30.*p1_raw30+p2_raw30.*p2_raw30;
%     p_raw_sq31=p1_raw31.*p1_raw31+p2_raw31.*p2_raw31; p_raw_sq32=p1_raw32.*p1_raw32+p2_raw32.*p2_raw32;
%     p_raw_sq33=p1_raw33.*p1_raw33+p2_raw33.*p2_raw33; p_raw_sq34=p1_raw34.*p1_raw34+p2_raw34.*p2_raw34;
%     p_raw_sq35=p1_raw35.*p1_raw35+p2_raw35.*p2_raw35; p_raw_sq36=p1_raw36.*p1_raw36+p2_raw36.*p2_raw36;
%     p_raw_sq37=p1_raw37.*p1_raw37+p2_raw37.*p2_raw37; p_raw_sq38=p1_raw38.*p1_raw38+p2_raw38.*p2_raw38;
%     p_raw_sq39=p1_raw39.*p1_raw39+p2_raw39.*p2_raw39; p_raw_sq40=p1_raw40.*p1_raw40+p2_raw40.*p2_raw40;
%     p_raw_sq41=p1_raw41.*p1_raw41+p2_raw41.*p2_raw41; p_raw_sq42=p1_raw42.*p1_raw42+p2_raw42.*p2_raw42;
%     p_raw_sq43=p1_raw43.*p1_raw43+p2_raw43.*p2_raw43; p_raw_sq44=p1_raw44.*p1_raw44+p2_raw44.*p2_raw44;
%     p_raw_sq45=p1_raw45.*p1_raw45+p2_raw45.*p2_raw45;
...
%     ; p_raw_sq30; p_raw_sq31; p_raw_sq32; p_raw_sq33; p_raw_sq34; p_raw_sq35; p_raw_sq35...
%     ; p_raw_sq37; p_raw_sq38; p_raw_sq39; p_raw_sq40; p_raw_sq41; p_raw_sq42; p_raw_sq43; p_raw_sq44; p_raw_sq45];
...
%     
KE_raw=sqrt(p_raw_sq1+1)-1; 
    KE_raw=0.5e3*KE_raw;
     [counts,centers] = hist(KE_raw,500);
 semilogy(centers,counts,'*b');hold on;
