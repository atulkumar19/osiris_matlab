...
pth8='/MS/FLD/e1/';
pth9='/MS/FLD/e2/';
pth10='/MS/PHA/p1x1/Elec1/';
pth11='/MS/PHA/p1x1/Elec2/';
pth12='/MS/PHA/p1x1/Elec3/';
pth13='/MS/PHA/p2x2/Elec1/';
pth14='/MS/PHA/p2x2/Elec2/';
pth15='/MS/PHA/p2x2/Elec3/';
pth16='/MS/PHA/p3x3/Elec1/';
pth17='/MS/PHA/p3x3/Elec2/';
pth18='/MS/PHA/p3x3/Elec3/';
...
for ii=1:length(frm)
    ...
    dset_psq=dset_p1.^2+dset_p2.^2+dset_p3.^2;
    dset_Totsq=dset_psq+1;
    dset_KinE=sqrt(dset_Totsq)-1;
    
    KinE0(1)=sum(sum(dset_KinE));     
    KinE(cnt)=sum(sum(dset_KinE));
    KinE_per(cnt)=KinE(cnt)- KinE0(1);
...
subplot(2,1,2)   
plot(timE,log(MagE),'b','LineWidth',2);
set(gca,'fontsize',12,'fontweight','b');
...
subplot(2,1,2)   
plot(timE,log(ElecE),'r','LineWidth',2);
set(gca,'fontsize',12,'fontweight','b');
...
subplot(2,1,2)   
plot(timE,log( KinE),'g','LineWidth',2);
set(gca,'fontsize',20,'fontweight','b');
