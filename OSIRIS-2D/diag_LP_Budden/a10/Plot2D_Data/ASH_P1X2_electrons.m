...
pth0='/home/atul/OSIRIS/MS-2.5-7-long';
...
%============AVI-FILE-NAME==========================
writerObj = VideoWriter ('phase_space_ele_m25_zoom.avi');
...
%     subplot(1,2,1)
    ...
    plot(x1_raw(1:100:length(x1_raw)),p1_raw(1:100:length(p1_raw)),'.b');
...
%     title(strcat('Energy (Electrons), t=',num2str(time_qe)));
  drawnow
