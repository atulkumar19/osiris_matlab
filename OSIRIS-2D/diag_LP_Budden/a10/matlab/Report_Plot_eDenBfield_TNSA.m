...
pth0='/home/testuser/OSIRIS/TNSA_B0';
% pth0='/home/testuser/OSIRIS/MagSonic_Soliton';
% pth0='/home/testuser/OSIRIS/dipole';
pth1='/MS/DENSITY/Elec1/charge/';
pth2='/MS/DENSITY/Ion1/charge/';
pth3='/MS/DENSITY/Elec2/charge/';
pth4='/MS/DENSITY/Ion2/charge/';
...
for ii=1:length(frm)   
    ...
    dset_qe=dset_qe1+dset_qe2+dset_qe3+dset_qe4;
    ...
    imagesc((dset_qe2+dset_qe4)','XData',[x1minqe x1maxqe],...
...
%     colormap(cmap)
    ...
    title(strcat('i-Density,t= ',num2str(time_qe)));
