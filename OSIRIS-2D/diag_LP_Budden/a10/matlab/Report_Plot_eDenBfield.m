...
%  pth0='/home/atul/OSIRIS/Budden_plane_test';
 pth0='/home/atul/OSIRIS/2DEM-cir-505';
%  pth0='/home/atul/OSIRIS/oblique_laser_LH';
% pth0='/home/testuser/OSIRIS/antena_test';
...
%============AVI-FILE-NAME==========================
writerObj = VideoWriter ('cir1D.avi');
...
% surf(dset_qe2(1:50:length(xg_qe), 1:50:length(yg_qe)))
    set(gca,'YDir','normal');
%     xlim([0 1500]);
...
%       caxis([1 2]);
    ...
    title(strcat('ion-density,t= ',num2str(time_qe)));
