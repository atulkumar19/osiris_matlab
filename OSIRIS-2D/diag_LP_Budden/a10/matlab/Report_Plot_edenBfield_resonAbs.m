...
% pth0='/home/testuser/OSIRIS/oblique_laser_nob1b2';
 pth0='/home/testuser/reson_absorp';
...
%============AVI-FILE-NAME==========================
writerObj = VideoWriter ('eden-Bfield_resonAbs.avi');
...
%     title(strcat('B-field,t= ',num2str(time_qe)));
 title(strcat('B_{1z}-field,t= ',num2str(time_qe)));
