...
%============AVI-FILE-NAME==========================
 aviobj = avifile ( 'mean-current-b-field', 'fps',5); 
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
for ii=1:length(frm)   
    ...
    [xg_qe,yg_qe,dset_J4,x1lt_J4,x2lt_J4,time_J5]=...
    ...
    title(strcat('mean-current J_x, t= ',num2str(time_qe)));
    ...
    plot(yg_qe,mean1_J2,'b','LineWidth',2);
     set(gca,'linewidth',2.0,'fontsize',20,'fontweight','b');
    title(strcat('mean-J_y-field, t= ',num2str(time_qe)));
      xlabel('x2(c/\omega_{pe})');
   ...
   ylabel('J_y(n_0ec)');
    ...
    plot(yg_b3,mean1_b3,'b','LineWidth',2);
     set(gca,'linewidth',2.0,'fontsize',20,'fontweight','b');
     title(strcat('mean-B-field, t= ',num2str(time_qe)));
      xlabel('x2(c/\omega_{pe})');
