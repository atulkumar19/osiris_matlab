...
%============AVI-FILE-NAME==========================
writerObj = VideoWriter ('EBd_m25_LH.avi');
...
%     subplot(2,3,1)
%     plot(xg_qe,mean1_J1,'b','LineWidth',1.0);
...
%    ylabel('J_y(n_0ec)');
    subplot(2,3,1)
    plot(xg_b3,mean1_b3,'b','LineWidth',1.0);
     set(gca,'linewidth',1.0,'fontsize',8 ,'fontweight','b');
     title(strcat(' t= ',num2str(time_qe)));
    xlim([0 1050]);
      xlabel('x1(c/\omega_{pe})');
   ...
   subplot(2,3,2)
    plot(xg_qe,mean1_E2,'b','LineWidth',1.0);
     set(gca,'linewidth',1.0,'fontsize',8,'fontweight','b');
      title(strcat(' t= ',num2str(time_qe)));
    xlim([0 1050]);
      xlabel('x1(c/\omega_{pe})');
    ...
    subplot(2,3,3)
    plot(xg_e2,mean1_E1,'b','LineWidth',1.0);
     set(gca,'linewidth',1.0,'fontsize',8,'fontweight','b');
    title(strcat(' t= ',num2str(time_qe)));
    xlim([0 1050]);
      xlabel('x1(c/\omega_{pe})');
    ...
    subplot(2,3,4)
    plot(xg_e3,mean1_qe,'b','LineWidth',1.0);
     set(gca,'linewidth',1.0,'fontsize',8,'fontweight','b');
      title(strcat(' t= ',num2str(time_qe)));
     xlim([0 1050]);
      
      xlabel('x1(c/\omega_{pe})')
       ylabel('plasma_den(n_0)');
       
    subplot(2,3,5)
    plot(xg_e3,mean1_qe1,'b','LineWidth',2);
     set(gca,'linewidth',2.0,'fontsize',8,'fontweight','b');
      title(strcat(' t= ',num2str(time_qe)));
        xlim([0 1050]);
      xlabel('x1(c/\omega_{pe})')
       ylabel('e-den(n_0)');
