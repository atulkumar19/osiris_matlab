...
ne=1.1e22; % cm^-3
frm=50:50;
 pth0='/home/atul/OSIRIS/2DEM-cir-505';
%  pth0='/home/atul/OSIRIS/EM_PRE_POS-1.15-0.505c';
...
pth2='/MS/DENSITY/ion/charge/';
 pth3='/MS/DENSITY/Beam_ion/charge/';
...
%============AVI-FILE-NAME==========================
writerObj = VideoWriter ('cir2D.avi');
...
%     subplot(2,3,1)
%     plot(xg_qe,smooth(mean_aa),'b','LineWidth',1.0);hold on;
%      plot(xg_qe,smooth(mean_bb),'r','LineWidth',1.0);
...
%     ylabel('J_x(n_0ec)');
%     subplot(2,3,2)
%     plot(xg_qe,mean1_J2,'b','LineWidth',1.0);
%      set(gca,'linewidth',1.0,'fontsize',10,'fontweight','b');
%     title(strcat(' t= ',num2str(time_qe)));
% %     xlim([0 100]);
%       xlabel('x1(c/\omega_{pe})');
...
% %    
%    subplot(2,3,4)
%     plot(xg_qe,smooth(mean1_E1),'k','LineWidth',1.0);
%      set(gca,'linewidth',1.0,'fontsize',10,'fontweight','b');
%       title(strcat(' t= ',num2str(time_qe)));
% %     xlim([450 1150]);
%       xlabel('x1(c/\omega_{pe})');
...
% %     subplot(2,3,5)
    plot(xg_e2,smooth(mean1_E2),'b','LineWidth',1.0);
     set(gca,'linewidth',1.0,'fontsize',10,'fontweight','b');
    title(strcat(' t= ',num2str(time_qe)));
   xlim([400 900]);
      xlabel('x1(c/\omega_{pe})');
...
%     subplot(2,3,6)
    plot(xg_qe,smooth(mean1_qe2),'r','LineWidth',2.0);hold on;
    plot(xg_qe,smooth(mean1_qe),'b','LineWidth',2.0);hold on;
    plot(xg_qe,smooth(mean1_qe1),'g','LineWidth',2.0);hold off;
     set(gca,'linewidth',1.0,'fontsize',10,'fontweight','b');
      title(strcat(' t= ',num2str(time_qe)));
    xlim([400 900]);
%     ylim([0.8 1.4])
