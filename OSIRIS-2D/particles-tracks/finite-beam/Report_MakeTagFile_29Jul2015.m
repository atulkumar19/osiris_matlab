...
pth0='/Volumes/Backup2/OSIRIS_RUN1/paper/f12-0.9c';
...
NTE4=20; %no of particles in a region
d4a4=8.4;  % species desnsity* area contained by the species
d5a5=75.6;
d6a6=816.0;
...
% 
% }
par_Loc_xy4= (((x2_raw4-15.0).^2)<=7.0^2)&(x1_raw4<=6.0);
...
% }
par_Loc_xy5= (((x2_raw5-15.0).^2)<=7.0^2)&(x1_raw5<=6.0);
...
% }
par_Loc_xy6= (((x2_raw6-15.0).^2)>7.0^2)|(x1_raw6>6.0);
