...
pth0='/scratch/atul';
pth1='/f2-MS-focal/DENSITY/Elec1/charge/';
pth2='/f2-MS-focal/DENSITY/Elec2/charge/';
pth3='/f2-MS-focal/DENSITY/Elec1/j1/';
pth4='/f2-MS-focal/DENSITY/Elec2/j1/';

pth5='/f2-MS-focal/FLD/b3/';
pth6='/f2-MS-focal/FLD/e1/';
pth7='/f2-MS-focal/FLD/e2/';
...
for ii=1:length(frm)
    ...
    MagF(cnt)=(sum(sum(dset_b3)))*2.5e-3;
