...
pth0='/home/atul/OSIRIS/Asym_Ion_Recon';
...
% %    
%     
    [xg_b3,yg_b3,dset_b1,x1lt_b3,x2lt_b3,time_b1]=...
...
dset_qe=dset_qe1+dset_qe2;
    ...
    [Ngx_LOb3,Ngy_LOb3]=size(dset_b1);
    Ngyby2b3=round(Ngy_LOb3/2);
    LOb3_dat=dset_b1(:,Ngyby2b3);
     [Br,B_theta]=cart2pol(dset_b1,dset_b2 );
  
    MagE(cnt)=sum(sum(B_theta.*B_theta))*dx_b3.^2;
    timE(cnt)=time_b3;
    cnt=cnt+1;
