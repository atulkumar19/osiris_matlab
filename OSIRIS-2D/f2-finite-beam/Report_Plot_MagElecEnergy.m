...
for ii=1:length(frm)
    ...
    fl_nm7=strcat(pth0,pth4,str_h4,str_num,str_ext);
    fl_nm8=strcat(pth0,pth5,str_h5,str_num,str_ext);
    fl_nm9=strcat(pth0,pth6,str_h6,str_num,str_ext);
    ...
    [xg_ene_EMF,yg_EMF,dset_EMF,x1lt_EMF,x2lt_EMF,time_EMF]=...
        ReadB313Aug2014(fl_nm7);
    
    [xg_ene_e,yg_ene_e,dset_ene_e,x1lt_ene_e,x2lt_ene_e,time_ene_e]=...
        ReadE113Aug2014(fl_nm8);
    
    [xg_ene_e,yg_ene_b,dset_ene_b,x1lt_ene_b,x2lt_ene_b,time_ene_b]=...
