...
pth0='/Users/repulsion/Desktop/OSIRIS_3D/atul_osiris/f2-high_resoln';
...
%     xmat = permute(xmat, [3 1 2]);
%     ymat = permute(ymat, [3 1 2]);
%     zmat = permute(zmat, [3 1 2]);
%     
    xyview = seg;
    xzview = seg;
    yzview = seg;
    ...
    subplot(2,2,1)
    imHandles1 = imagesc(squeeze(xyview(:,:,500)),...
